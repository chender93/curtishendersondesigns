          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav text-info">
              <li className="nav-item">
                <a data-testid="about" className="nav-link active text-info" aria-current="page" href="#about">ABOUT</a>
              </li>
              <li className="nav-item">
                <a data-testid="projects" className="nav-link active text-primary" href="#projects">PPROJECTS</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active text-info" href="#contact">CONTACT</a>
              </li>
              <li className="nav-item">
